...
struct sec_therm_platform_data sec_therm_pdata = {
	...
	defined(CONFIG_MACH_MS01_CHN_CMCC_3G) || defined(CONFIG_MACH_MS01_CHN_CTC) || defined(CONFIG_MACH_Q7_CHN_SGLTE) || \
	defined(CONFIG_MACH_VICTOR_CHN_SGLTE) || defined(CONFIG_MACH_VICTOR_CHN_SGLTE_CU) || defined(CONFIG_MACH_CRATERVE_CHN_CTC)
