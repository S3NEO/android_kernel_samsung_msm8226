...
/*Wacom Command*/
	...
	defined(CONFIG_MACH_HLLTE) || defined(CONFIG_MACH_HL3G) || defined(CONFIG_MACH_HLITE_CHN_SGLTE)
...
#if defined(CONFIG_MACH_HLLTE) || defined(CONFIG_MACH_HL3G) || defined(CONFIG_MACH_HLITE_CHN_SGLTE)
