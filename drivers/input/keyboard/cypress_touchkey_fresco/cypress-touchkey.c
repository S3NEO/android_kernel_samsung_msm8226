...
#elif defined(CONFIG_MACH_HLLTE) ||	defined(CONFIG_MACH_HL3G) || defined(CONFIG_KEYBOARD_CYPRESS_TKEY_20055)
...
#endif
	touchkey_stop(data);
	gpio_tlmm_config(GPIO_CFG(tkey_gpio_int, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), 1);
	...
	const struct i2c_device_id *id)
{
	...
	struct touchkey_i2c *tkey_i2c;
	#if defined(TK_USE_LCDTYPE_CHECK) || defined(CONFIG_KEYBOARD_CYPRESS_TKEY_20055)
	bool bforced = false;
	#endif
