...
{
#if defined(CONFIG_MACH_CRATERQ) || defined(CONFIG_MACH_S3VE) || defined(CONFIG_MACH_CRATERVE_CHN_CTC) ||defined(CONFIG_MACH_S3VE_CHN_CTC)
			...
			struct device_attribute *attr, char *buf)
{
	...
	return snprintf(buf, sizeof(cam_fw), "%s", cam_fw);
#elif defined(CONFIG_MACH_S3VE) || defined(CONFIG_MACH_S3VE_CHN_CTC) || defined(CONFIG_MACH_CRATERVE_CHN_CTC)
	char cam_fw[] = "B08QTGJ01MI B08QTGJ01MI\n";
	return snprintf(buf, sizeof(cam_fw), "%s", cam_fw);
#elif defined(CONFIG_MACH_CRATERQ) 
	char cam_fw[] = "B08QTGJ01MK B08QTGJ01MK\n";
	return snprintf(buf, sizeof(cam_fw), "%s", cam_fw);
#elif defined(CONFIG_MACH_CS03_SGLTE) || defined(CONFIG_MACH_Q7_CHN_SGLTE) || defined(CONFIG_MACH_VICTOR_CHN_SGLTE) || defined(CONFIG_MACH_VICTOR_CHN_SGLTE_CU)
