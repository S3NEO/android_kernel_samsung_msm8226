...
#define CAMERA_SCENE_SPORT		12
#define CAMERA_SCENE_PARTY		13
#define CAMERA_SCENE_BEACH		7
#define CAMERA_SCENE_SUNSET		9
...
typedef struct cam_soc_focus_config
{
    int mFocusMode;
    int step;
} cam_soc_focus_config;
...
typedef struct
{
	...
	unsigned short isFocusFin;
	unsigned short islowlight;
} exif_data_t;
